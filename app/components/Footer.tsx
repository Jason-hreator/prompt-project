    ...
    <footer className="bg-gray-900 border-t border-gray-800 py-10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-bold mb-4 text-white">提示精灵</h3>
            <p className="text-gray-400 text-sm">
              提示精灵是一个AI提示词分享社区，旨在帮助用户更有效地使用AI工具和大型语言模型，探索人工智能的无限可能。
            </p>
          </div>
          
          <div>
            <h3 className="text-lg font-bold mb-4 text-white">链接</h3>
          ...
          <div>
            <h3 className="text-lg font-bold mb-4 text-white">法律信息</h3>
            <ul className="space-y-2">
              <li>
